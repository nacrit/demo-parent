...
public class DateUtils {
    ...
    public static String getIntervalBySeconds(long seconds) {
        ...
        if (seconds < SECONDS_PER_MINUTE) {
            builder.append(seconds).append("秒前");
        } else if (seconds < SECONDS_PER_HOUR) {
            builder.append((long) Math.floor(seconds / SECONDS_PER_MINUTE)).append("分钟前");
        } else if (seconds < SECONDS_PER_DAY) {
            builder.append((long) Math.floor(seconds / SECONDS_PER_HOUR)).append("小时前");
        } else if (seconds < SECONDS_PER_WEEK) {
            builder.append((long) Math.floor(seconds / SECONDS_PER_DAY)).append("天前");
        } else if (seconds < SECONDS_PER_MONTH) {
            builder.append((long) Math.floor(seconds / SECONDS_PER_WEEK)).append("周前");
        } else if (seconds < SECONDS_PER_YEAR) {
            builder.append((long) Math.floor(seconds / SECONDS_PER_MONTH)).append("月前");
        } else {
            builder.append((long) Math.floor(seconds / SECONDS_PER_YEAR)).append("年前");
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(format(date, DATETIME_PATTERN));
        date = getLastDayOfLastMonth();
        System.out.println(format(date, DATETIME_PATTERN));
        long endTime = System.nanoTime();
        System.out.println(startTime + "ns");

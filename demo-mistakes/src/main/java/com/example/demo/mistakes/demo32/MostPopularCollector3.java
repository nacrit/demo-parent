 ...
 */
public class MostPopularCollector3<T>
        implements Collector<T, Map<T, AtomicInteger>, Optional<T>> {
     ...
     */
    @Override
    public Supplier<Map<T, AtomicInteger>> supplier() {
     ...
     */
    @Override
    public BiConsumer<Map<T, AtomicInteger>, T> accumulator() {
     ...
     */
    @Override
    public BinaryOperator<Map<T, AtomicInteger>> combiner() {
        return (m1, m2) -> {
     ...
     */
    @Override
    public Function<Map<T, AtomicInteger>, Optional<T>> finisher() {

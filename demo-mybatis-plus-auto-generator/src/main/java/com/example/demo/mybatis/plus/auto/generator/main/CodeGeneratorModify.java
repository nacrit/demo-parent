...
public class CodeGeneratorModify {
    private static String MODEL_NAME = "demo-mybatis-plus-auto-generator";
    private static String PACKAGE_NAME = "com.example.demo.mybatis.plus.auto.generator.test2";
...
//        MODEL_NAME = scanner("模块名");
//        PACKAGE_NAME = scanner("包名");
...
//        dsc.setDriverName("com.mysql.jdbc.Driver");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + File.separator + MODEL_NAME + "/src/main/resources/mapper/"
...
//        strategy.setTablePrefix("alicms_"); // 设置表前缀

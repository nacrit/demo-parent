package com.example.demo.design_pattern.a_head_first_design_patterns.z_apply.d3_beancopy;
...
public class BeanCopyController {
    ...
    @Data
    public static class ComplicatedOrderDO {
        private Long id;
    ...
    @Data
    public static class ComplicatedOrderDTO {
        private Long id = 1L;
